...
2. Follow up question: How does photosynthesis work?
Rephrased: Photosynthesis working
3. Follow up question: When was the Eiffel Tower built?
Rephrased: Eiffel Tower construction date
Conversation:
{chat_history}
...
// Web search: plain generic persona, no focus-mode line, no "retrieved by X".
...
// Web omits engines — falls back to searxng defaults.
const handleWebSearch = createSearchAndAnswerAgent({
  retrieverPrompt,
  responsePrompt,
  searxngOptions: {},
});
